...
As entry point the Capabilities document of the service is expected (as reference or file).

If the service supports basic authentication for the Transaction and Harvest operation,
the user name and password can be passed via system properties:
...
<properties version="1.0">
    <comment>Sample test run arguments (ets-cat20-dgiwg)</comment>
