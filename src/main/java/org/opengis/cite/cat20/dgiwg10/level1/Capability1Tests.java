package org.opengis.cite.cat20.dgiwg10.level1;
...
import org.opengis.cite.cat20.dgiwg10.ErrorMessageKeys;
...
public class Capability1Tests extends CommonFixture {
     ...
     * {@link org.opengis.cite.cat20.dgiwg10.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/cat20-dgiwg10/rnc/atom.rnc");
