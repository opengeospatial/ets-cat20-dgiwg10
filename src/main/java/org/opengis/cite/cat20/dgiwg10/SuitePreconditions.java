...
public class SuitePreconditions {
	...
	/**
	 * Verifies that the test subject is a CSW 2.0 service. The document element in the
	 * supplied metadata resource must be
	 * "{http://www.opengis.net/cat/csw/2.0.2}Capabilities".
	...
	public void verifyCapabilities(ITestContext testContext) {
		Document capabilitiesDocument = (Document) testContext.getSuite()
	 ...
	 * @param testContext the test context, never <code>null</code>
	 */
