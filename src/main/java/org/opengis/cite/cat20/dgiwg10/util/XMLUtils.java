...
public class XMLUtils {
     ...
     * @param nsBindings
     *            A collection of namespace bindings required to evaluate the query, where each entry maps a namespace
     *            URI (key) to a prefix (value).
     * @return An XdmValue object representing a value in the XDM data model.
     * @throws SaxonApiException
     *             If an error occurs while evaluating the query (this always wraps some other underlying exception).
     */
    ...
    /**
     * Creates a DOM Document with the given Element as the document element. A deep copy of the element is imported;
     * the source element is not altered.
     *
     * @param elem
     *            An Element node.
